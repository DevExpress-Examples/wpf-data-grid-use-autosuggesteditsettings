...
Namespace DXSample
	Partial Public Class MainWindow
		...
		Public Sub New()
			Items = New ObservableCollection(Of Item) From {
				New Item With {.Value = "A"},
				New Item With {.Value = "B"},
				New Item With {.Value = "C"}
			}
			DataContext = Me
			InitializeComponent()
		End Sub
		...
		Private Sub ShownEditor(ByVal sender As Object, ByVal e As EditorEventArgs)
			...
			If ActiveEditor IsNot Nothing Then
				AddHandler ActiveEditor.QuerySubmitted, AddressOf QuerySubmitted
			End If
		End Sub
